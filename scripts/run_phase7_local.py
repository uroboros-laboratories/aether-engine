...
def _write_ui_config(dist: Path, service_url: str, service_host: str, service_port: int) -> None:
    ...
    payload = {
        ...
        # Keep the protocol flexible so the UI can mirror the page origin (e.g. https
        # in forwarded tunnels) instead of forcing http and triggering mixed-content
        # fetch failures in browsers.
        "protocol": "auto",
    }
