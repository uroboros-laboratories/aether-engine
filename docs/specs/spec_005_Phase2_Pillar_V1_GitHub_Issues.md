# SPEC-005 — Phase 2 GitHub Issue Mapping (Pillar V1 Generalisation)

## Milestone + labels for Phase 2
...
- [ ] Extend envelope creation so:
  ...
  - [ ] Other scenarios can declare CTRL envelopes (e.g. start/stop, governance messages).
- [ ] Add tests:
