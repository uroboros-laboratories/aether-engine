# SPEC-002 — Phase 1 GitHub Issue Mapping (GF-01 CMP-0 Baseline)
...
**Suggested labels (create them once in the repo):**
...
You don’t have to use all of them on each issue; the per-issue sections below suggest labels inline.
...
- [ ] Implement `Profile_CMP_0_v1` type with:
  - [ ] `name = "CMP-0"`
...
- [ ] A `TopologyProfile_v1` + `Profile_CMP0_v1` pair exists for GF-01.
...
## Issue 5 — NAPEnvelope & Minimal Gate/TBP
